        ...
        if (!empty($empleado) && !empty($nombre))
            {
              ...
              $sql=$cnnPDO->prepare("INSERT INTO profesores (empleado, nombre) VALUES (:empleado, :nombre)");
...
<br>
<br>
<h1 style="font-family:impact;";><center>Registro De Profesores</center></h1>
...
<section class="vh-100">
  ...
  <button name="registrar" id="btn-registro" type="submit" class="btn btn-black btn-block mb-4">Registar Profesor</button></center>
</div>
</form>
