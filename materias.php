        ...
        if (!empty($idmateria) && !empty($nombre))
            {
              ...
              $sql=$cnnPDO->prepare("INSERT INTO materia (idmateria, nombre) VALUES (:idmateria, :nombre)");
...
<br>
<br>
<h1 style="font-family:impact;";><center>Registro De Materias</center></h1>
<br>
...
<section class="vh-100">
  ...
  <button name="registrar" id="btn-registro" type="submit" class="btn btn-black btn-block mb-4">Registar Materia</button>
</div></center>
</form>
