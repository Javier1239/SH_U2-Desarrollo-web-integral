...
if (isset($_POST['actualizar']))
{
  ...
  //Query de consulta
  $query = $cnnPDO->prepare('UPDATE from materia WHERE idmateria =:idmateria');
...
if (isset($_POST['eliminar']))
{
  ...
  //Query de consulta
  $query = $cnnPDO->prepare('DELETE from materia WHERE idmateria =:idmateria');
...
if (isset($_POST['buscar']))
{
  ...
  //Query de consulta
  $query = $cnnPDO->prepare('SELECT * from materia WHERE idmateria =:idmateria');
...
<?php
    ...
    $nombre=$_POST['nombre'];
       ...
       if (!empty($idmateria) && !empty($nombre))
            {
               //Actualizamod los datos en la tabla de la db  
              $sql = $cnnPDO->prepare(
                'UPDATE materia SET idmateria =:idmateria, nombre = :nombre WHERE idmateria = :idmateria'
              );
...
<h1 style="font-family:impact;";><center>Editar Materias</center></h1>
<br>
...
<section class="vh-100">
  ...
  <div class="form-outline mb-4">
    <input type="text" id="form6Example3" class="form-control" name="idmateria" placeholder="Id de la materia"/>
    <label style="color:#FFFFFF" class="form-label" for="form6Example3">Id de la materia</label>
  </div>

   <!-- Text input -->
  <div class="form-outline mb-4">
    <input type="text" id="form6Example3" class="form-control" name="nombre" placeholder="Nombre"/>
    <label style="color:#FFFFFF" class="form-label" for="form6Example3">Nombre</label>
  </div>
